...
export default function Profile() {
  ...
  function deleteItem(id) {
    if (
      window.confirm("Did you really want to remove that item  from wishlist")
    ) {
  ...
  return (
    <>
      ...
      <div className="container my-3">
        ...
        <h5 className="bg-warning text-center p-2 my-3">Wishlist Section</h5>
        {wishlist.length ? (
          <>
        ...
        <h5 className="bg-warning text-center p-2 my-3">
        ...
        {orders.length ? (
          orders.map((item, index) => {
            return (
              <div
                className="row border-bottom border-2 border-primary"
                key={index}
              >
