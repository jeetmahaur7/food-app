  ...
  return (
    <table className="table table-bordered">
      <tbody>
        ...
        <tr>
          <td colSpan={2}>
            <Link to="/update-profile" className="btn btn-warning w-100">
              Update Profile
            </Link>
          </td>
        </tr>
...
export default function BuyerProfile(props) {
  ...
  return props.title ? (
    <>
      <h5 className="bg-warning text-center p-2">Billing Details</h5>
      {tableDisplay(user)}
    </>
  ) : (
    <div className="row">
      ...
      <div className="col-md-6">{tableDisplay(user)}</div>
    </div>
  );
}
