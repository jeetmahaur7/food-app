        ...
        <div className="container py-5">
          ...
          <div className="row g-5">
            ...
            <div className="col-xl-6 wow fadeInRight" data-wow-delay="0.4s">
              <div>
                <h4 className="text-warning">Send Your Message</h4>
                ...
                <div className="row g-4">
                  ...
                  >
                    <div className="contact-add-item">
                      <div className="contact-icon text-warning mb-4">
                        <i className="fas fa-map-marker-alt fa-2x"></i>
                      </div>
                      <div>
                        <h4>Address</h4>
                        <p className="mb-0">
                          A-43 Sector-16 Noida,Uttar Pradesh
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="contact-add-item">
                      ...
                      <div>
                        <h4>Mail Us</h4>
                        <p className="mb-0">
                          <Link to="mailto:info@apnarasoi.com">
                            info@apnarasoi.com
                          </Link>
                        </p>
                      </div>
                  ...
                  >
                    <div className="contact-add-item">
                      ...
                      <div>
                        ...
                        <p className="mb-0">
                          <Link to="https://wa.me/+91xxxxxxxxxx">
                            +91 xxxxxxxxxx
                          </Link>
                        </p>
                      </div>
